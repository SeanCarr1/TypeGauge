	...
	public List<String> getSampleTexts() {
		...
		case BEGINNER:
			return Arrays.asList(
				...
				"This is a simple practice sentence number 1.",
				"Keep your fingers on the home row.",
				"The quick brown fox jumps over 3 lazy dogs.",
				"Take a short break, then try again 2 times.",
				"Use both hands when you type.",
				"Look at the screen, not the keys.",
				"Small steps help you improve every 5 minutes.",
				"Press each key with gentle force.",
				"To be, or not to be, that is the question.");
		case INTERMEDIATE:
			return Arrays.asList(
				"It's a busy day, so I'll practice carefully. Don't rush, keep your eyes on the text. When you miss a key, correct it and continue in 3 steps.",
				...
				"I think, therefore I am. I can't always type fast, but I can type cleanly. If you see a comma, type it, then move on. Don't forget the period at the end.",
				...
				"You're practicing punctuation, so be precise. Type commas, periods, and apostrophes exactly as shown. When you're done, review your pace and relax 1 more time.");
		case ADVANCED:
			return Arrays.asList(
				...
				"All that glitters is not gold. Precision isn't optional in technical writing; choose exact verbs, avoid vague modifiers, and let structure, not flourish, carry meaning 2 times.");
		default:
